...
class GUI():
    def __init__(self,master):
        ...
        root.config(bg="#4C90A2")
        root.resizable(False, False)

        self.label = Label(text="~PASSWORD GENERATOR~", anchor=N, fg='darkblue', bg="#7C8D90", font='arial 20 bold underline')
        ...
        self.user = Label(text="Enter User Name: ", font='times 15 bold', bg="#63B660", fg='darkblue')
        ...
        self.length = Label(text="Enter Password Length: ", font='times 15 bold', bg="#67D1CF", fg='darkblue')
        ...
        self.generated_password = Label(text="Generated Password: ", font='times 15 bold', bg="#009DFF", fg='darkblue')
        self.generated_password.grid(row=8, column=0)

        self.generated_password_textfield = Entry(textvariable=self.n_generatedpassword, font='times 15', bd=6, relief='ridge', fg="#1B4692")
